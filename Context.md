...
### 2026-09-26 — Incumplimientos de pago; ofrecimientos nuevos sin perder el anterior (SQL 22 pendiente)
...
*   **SQL 22** (`sql/2026-09-26_22_historial_ofertas_inicial.sql`, ⏳ **pendiente de correr**): pasa al historial el primer ofrecimiento (si era distinto) y el último de cada caso que todavía no tiene historial; el último queda "Aceptada" si el caso está en Esperando pago o Cobrado. Se puede volver a correr.

...
### 2026-09-26 — Resumen diario en el celular (⏳ falta redesplegar la función "notificar")
...
### 2026-09-26 — Historial de ofertas y contacto en la compañía (SQL 21 pendiente de correr)
*   **SQL 21** (`sql/2026-09-26_21_ofertas_y_contactos.sql`, ⏳ **pendiente de correr**): tablas `pas_ofertas` (cada ofrecimiento: fecha, monto, respuesta pendiente/rechazada/contraoferta/aceptada, contraoferta, nota), `pas_caso_contactos` (liquidador del caso: nombre, teléfono, mail, notas) y `pas_companias` (directorio: mail y teléfono de siniestros por compañía). **Solo administrador** (RLS `es_admin()`): el PAS y el cliente no las ven. Sin el SQL, las tarjetas avisan "falta correr el SQL 21".

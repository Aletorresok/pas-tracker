...
// Placeholder para ClienteCard - reemplazar con el componente real
    ...
    <div style={{ background: darkMode ? "#1e293b" : "#f8fafc", border: `1px solid ${darkMode ? "#2d3f55" : "#e2e8f0"}`, borderRadius: 10, padding: 14, marginBottom: 10 }}>
      ...
      {expanded && (
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: `1px solid ${darkMode ? "#2d3f55" : "#e2e8f0"}` }}>
          {filtered.length === 0 ? (
            <div style={{ color: darkMode ? "#64748b" : "#94a3b8", fontSize: 12, textAlign: "center", padding: 16 }}>
...
// Placeholder para CasoModal - reemplazar con el componente real
...
// Placeholder para NuevoPASModal - reemplazar con el componente real
      ...
      if (casosPas.length === 0) {
        ...
        casosPas.forEach(c => {
          rows.push({ 
            ...
            Estado: c.estado, 
            "Fecha derivación": c.fecha_derivacion || "", 
            "Monto ofrecimiento": c.monto_ofrecimiento || "", 
            "Cobré yo": c.monto_cobro_yo || "", 
            "Cobró asegurado": c.monto_cobro_asegurado || "", 
            "Comisión PAS": c.monto_comision_pas || "", 
            Nota: c.nota || "" 
          });
        });
      }
